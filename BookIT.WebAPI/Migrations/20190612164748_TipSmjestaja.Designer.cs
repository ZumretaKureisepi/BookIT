...
namespace BookIT.WebAPI.Migrations
{
    ...
    [Migration("20190612164748_TipSmjestaja")]
    partial class TipSmjestaja
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookIT.WebAPI.Database.SmjestajOcjena", b =>
                {
                    b.Property<int>("SmjestajOcjenaId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<DateTime>("DatumOcjene");

                    b.Property<double>("FinalnaOcjena");

                    b.Property<int>("KlijentId");

                    b.Property<int>("OcjenaCistoca");

                    b.Property<int>("OcjenaDodatneUsluge");

                    b.Property<int>("OcjenaIsplativost");

                    b.Property<int>("OcjenaLokacija");

                    b.Property<string>("OcjenaOpisno");

                    b.Property<int>("OcjenaUdobnost");

                    b.Property<int>("OcjenaVlasnikSmjestaja");

                    b.Property<int>("SmjestajId");

                    b.HasKey("SmjestajOcjenaId");

                    b.HasIndex("KlijentId");

                    b.HasIndex("SmjestajId");

                    b.ToTable("SmjestajiOcjene");
                });
            ...
            modelBuilder.Entity("BookIT.WebAPI.Database.SmjestajTipDestinacije", b =>
                {
                    b.Property<int>("SmjestajTipDestinacijeId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int>("SmjestajId");

                    b.Property<int>("TipDestinacije");

                    b.HasKey("SmjestajTipDestinacijeId");

                    b.HasIndex("SmjestajId");

                    b.ToTable("SmjestajiTipDestinacija");
                });
            ...
            modelBuilder.Entity("BookIT.WebAPI.Database.SmjestajTipDestinacije", b =>
                {
                    b.HasOne("BookIT.WebAPI.Database.Smjestaj", "Smjestaj")
                        .WithMany("SmjestajTipDestinacije")
                        .HasForeignKey("SmjestajId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
